...
## Details
No major AI provider (OpenAI, Google, Anthropic) has documented llms.txt as an input to citation pipelines. Adoption at ~10% of domains. OtterlyAI's 90-day bot audit: out of 62,100+ AI bot visits, only 84 requests targeted /llms.txt path. The file has genuine value for agentic RAG pipelines and documentation feeds, but zero measurable impact on AI search citation rates. Treat as future-proofing insurance with 10-min implementation cost.
