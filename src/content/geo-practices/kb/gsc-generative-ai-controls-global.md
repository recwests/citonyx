---
title: Google Rolls Out a Generative AI Opt-Out Toggle Driven by UK Regulation
description: Search Console's new 'Search generative AI control' lets sites opt out
  of AI Overviews, AI Mode and Discover AI; rolled out from June 2026, required by
  the UK CMA, expanding beyond UK sites.
practice_type: tools
confidence: verified
...
difficulty: beginner
related: [gsc-ai-mode-segmentation, cloudflare-three-tier-crawler-classification]
conflicts_with: []
manual: false
hub: tools
---
## Summary
Google is rolling out a Search Console setting — the 'Search generative AI control' — that removes a site from AI Overviews, AI Mode and Discover's generative AI features without affecting regular rankings. Defaulting to inclusion, it stems from a UK CMA requirement and rolls out from June 2026, first to UK site owners and then beyond. Multiple US-based site owners confirmed seeing the setting. Access via Settings or search.google.com/search-console/settings/search-gen-ai.
